...
func (db *DB) AddConversationToGroup(conversationID, groupID string) error {
	...
	if err != nil {
		return fmt.Errorf("failed to delete old conversation group associations: %w", err)
	}
...
func (db *DB) UpdateConversationPinned(id string, pinned bool) error {
	...
	if err != nil {
		return fmt.Errorf("failed to update conversation pin status: %w", err)
	}
	return nil
}
...
func (db *DB) UpdateGroupPinned(id string, pinned bool) error {
	...
	if err != nil {
		return fmt.Errorf("failed to update group pin status: %w", err)
	}
	return nil
}
...
func (db *DB) UpdateConversationPinnedInGroup(conversationID, groupID string, pinned bool) error {
	...
	if err != nil {
		return fmt.Errorf("failed to update group conversation pin status: %w", err)
	}
	return nil
}
